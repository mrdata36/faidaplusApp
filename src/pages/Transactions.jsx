...
const transactionCategories = {
  ...
  expense: ['Stock Purchase', 'Rent', 'Utilities', 'Transport', 'Salaries', 'Other']
};
    ...
    <Layout>
      <div className="max-w-7xl mx-auto p-6">
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between mb-8">
          ...
          <button
            onClick={() => openModal()}
            className="flex items-center gap-2 bg-brand-picton text-white px-6 py-3 rounded-lg hover:bg-brand-battery transition-colors shadow-sm"
          >
                      ...
                      <tr key={transaction.id} className="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                        ...
                        <td className="px-6 py-4 text-sm space-x-3">
                          <button
                            ...
                            className="text-brand-bluecola hover:text-brand-trueblue transition-colors"
                          >
              ...
              <div className="px-6 py-4 border-t border-slate-200 dark:border-slate-700 flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-3 py-1 text-sm border border-slate-300 dark:border-slate-600 rounded-lg text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
                    {t('previous') || 'Previous'}
                  </button>
                  <button

...
const Notifications = () => {
  ...
  const deleteNotification = async (id) => {
    if (!window.confirm(t('confirm_delete') || 'Delete this notification?')) return;
    setLoading(true);
    try {
  ...
  const clearNotifications = async () => {
    if (!window.confirm(t('confirm_clear_all') || 'Clear all notifications?')) return;
    setLoading(true);
    try {
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between mb-8">
          ...
          {notifications.length > 0 && (
            <button
              ...
              className="flex items-center gap-2 bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 transition-colors cursor-pointer shadow-md text-sm font-semibold"
            >
                    ...
                    <div className="flex gap-2">
                      {!notification.is_read && (
                        <button
                          ...
                          className="flex items-center gap-2 bg-brand-bluecola text-white px-4 py-2 rounded-lg hover:bg-brand-trueblue transition-colors text-sm font-semibold cursor-pointer shadow"
                        >
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 transition-colors text-sm font-semibold cursor-pointer shadow"
                      >
                        <Trash2 className="w-4 h-4" />
                        {t('delete') || 'Delete'}
                      </button>
